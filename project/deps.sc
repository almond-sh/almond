...
object Deps {
  ...
  def ammoniteRepl(sv: String)     =
    ...
    else ivy"com.lihaoyi:ammonite-cross-3.1.1-repl_${ScalaVersions.cross2_3Version}:${Versions.ammonite}"
  def ammoniteReplApi(sv: String)  =
    ...
    else ivy"com.lihaoyi:ammonite-cross-3.1.1-repl-api_${ScalaVersions.cross2_3Version}:${Versions.ammonite}"
  ...
  def fs2                      = ivy"co.fs2::fs2-core:2.5.10"
  ...
  def mdoc                     = ivy"org.scalameta::mdoc:2.3.1"
