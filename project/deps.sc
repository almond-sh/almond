...
object Deps {
  ...
  def upickle =
    ivy"com.lihaoyi::upickle:3.1.2" // trying to use the same version as Ammonite, to avoid bin compat issues
  def upickleCompat(sv: String) =
    ...
    if (sv.startsWith("2.")) ivy"com.lihaoyi::upickle:3.1.2"
    else ivy"com.lihaoyi:upickle_2.13:3.1.2"
