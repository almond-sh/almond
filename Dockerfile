...
# docker build --build-arg ALMOND_VERSION=0.13.1 --build-arg SCALA_VERSIONS="3.1.3" .
...
RUN wget -qO /usr/local/bin/coursier https://github.com/coursier/coursier/releases/download/v2.1.0-M6-53-gb4f448130/coursier && \
...
# i.e SCALA_VERSIONS="3.0.0 3.1.3"
ARG SCALA_VERSIONS
USER $NB_UID
