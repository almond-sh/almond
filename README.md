...
Find it in [`docs/pages/dev-from-sources.md`](https://github.com/almond-sh/almond/blob/main/docs/pages/dev-from-sources.md) in the sources for more details, and soon
